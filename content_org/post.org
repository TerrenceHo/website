...
** TODO My new grad job search and my view on interviews     :interviews:job:
   :PROPERTIES:
   :EXPORT_FILE_NAME: new-grad-interview-thoughts
   :EXPORT_HUGO_SECTION: post
...
:PROPERTIES:
:EXPORT_HUGO_SECTION: finance_post
:EXPORT_HUGO_CUSTOM_FRONT_MATTER:
:END:

** TODO My Banking Setup                                   :fidelity:banking:
   :PROPERTIES:
   :EXPORT_FILE_NAME:fidelity-cma
   :END:

** TODO Zero Emergency Fund?
