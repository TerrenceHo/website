...
## A note on unfairness {#a-note-on-unfairness}
...
## Maximizing Signalling and Discoverability {#maximizing-signalling-and-discoverability}
...
### Go to a well respected college {#go-to-a-well-respected-college}
...
#### Smart people want to work with smart people {#smart-people-want-to-work-with-smart-people}
...
#### Companies want to hire smart people {#companies-want-to-hire-smart-people}
...
### Resume signalling {#resume-signalling}

The following is some resume advice.


### Avoiding Application Paralysis {#avoiding-application-paralysis}
...
## Job search trends {#job-search-trends}


### Debugging interviews are on the rise. {#debugging-interviews-are-on-the-rise-dot}


### Algorithm interviews are still highly present. {#algorithm-interviews-are-still-highly-present-dot}


### Apply to jobs other than software engineering. {#apply-to-jobs-other-than-software-engineering-dot}
...
According to the [StackOverflow 2019 Survey](https://insights.stackoverflow.com/survey/2019), DevOps and Site Reliability
...
### Know language specifics {#know-language-specifics}
...
### Job openings flows and ebbs {#job-openings-flows-and-ebbs}
